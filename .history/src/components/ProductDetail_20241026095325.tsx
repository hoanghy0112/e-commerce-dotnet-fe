...
export default function ProductDetail({ productId }: ProductDetailProps) {
  ...
  <div className="bg-gray-50 p-6 rounded-lg shadow-md border border-gray-300">
    ...
    <button className=" flex items-center mt-auto w-full md:w-2/3 lg:w-1/2 mx-auto py-2 px-6 border-2 border-gray-800 rounded-lg bg-white hover:bg-gray-800 hover:text-white text-gray-800 transition-colors duration-200 font-medium">
      View detailed
    </button>
  </div>
