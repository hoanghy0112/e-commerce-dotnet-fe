    ...
    <div className="container mx-auto px-4 py-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-10">
        ...
        <div className="p-6 rounded-lg shadow-md border border-gray-300">
          <h2 className="text-2xl font-bold mb-4 bg-gray-100  text-gray-800">Specifications</h2>
          ...
          <button className="mt-4 border px-6 py-3 rounded-lg bg-blue-500 hover:bg-blue-600 text-white text-sm font-medium">View detailed</button>
        </div>
      </div>
