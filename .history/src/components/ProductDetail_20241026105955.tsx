...
"use client"
import { useState, useEffect, AwaitedReactNode, JSXElementConstructor, Key, ReactElement, ReactNode, AwaitedReactNode, JSXElementConstructor, Key, ReactElement, ReactNode } from "react";
        ...
        <div className="w-full md:w-1/2 px-4">
          ...
          <div className="mt-4">
            ...
            <div className="flex gap-2">
              {product.storage.map((option: boolean | ReactElement<any, string | JSXElementConstructor<any>> | Iterable<ReactNode> | Promise<AwaitedReactNode> | Key | null | undefined) => (
                <button
                  key={option}
          ...
          <div className="mt-4">
            ...
            <div className="flex gap-2">
              {product.colors.map((color: boolean | ReactElement<any, string | JSXElementConstructor<any>> | Iterable<ReactNode> | Promise<AwaitedReactNode> | Key | null | undefined) => (
                <button
                  key={color}
                  className="border px-4 py-2 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 bg-gray-100 hover:bg-gray-200"
                >
