    ...
    <div className="container mx-auto px-4 py-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-10">
        ...
        <div className="p-6 rounded-lg shadow-md border border-gray-300">
          ...
          <div className="flex justify-center mt-4">
            <button className="flex items-center border-2 border-gray-800 gap-2 px-4 py-3 rounded-full bg-white hover:bg-gray-800 hover:text-white text-gray-800 transition-colors duration-200 font-medium">
              <span>View detailed</span>
              {/* Icon here */}
              <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M19 9l-7 7-7-7" />
