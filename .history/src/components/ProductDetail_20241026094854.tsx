...
export default function ProductDetail({ productId }: ProductDetailProps) {
  ...
  <div className="bg-gray-50 p-6 rounded-lg shadow-md border border-gray-300">
    ...
    <button className="mt-auto w-full md:w-2/3 lg:w-full mx-auto py-3 px-8 rounded-lg bg-gray-800 text-white hover:bg-gray-900 transition-colors duration-200 font-medium">
      View detailed
    </button>
  </div>
