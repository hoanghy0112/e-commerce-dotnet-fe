    ...
    <div className="container mx-auto px-4 py-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-10">
        ...
        <div className="bg-gray-50 p-6 rounded-lg shadow-md border border-gray-300">
          ...
          <button className="border px-4 py-2 rounded-lg bg-white hover:bg-gray-100 text-gray-800 mt-4">
            View detailed
          </button>
        </div>
        ...
        {/* Bottom Button */}
        <button className="mt-4 border px-8 py-3 rounded-lg bg-white hover:bg-gray-200 text-gray-800 text-base font-medium mx-auto">
          View detailed
        </button>
      </div>
