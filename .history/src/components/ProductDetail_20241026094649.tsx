...
export default function ProductDetail({ productId }: ProductDetailProps) {
  ...
  <div className="bg-gray-50 p-6 rounded-lg shadow-md border border-gray-300">
    ...
    <button className="mt-4 border-2 border-gray-800 px-6 py-2 rounded-full bg-white hover:bg-gray-800 hover:text-white text-gray-800 font-medium transition-colors duration-200">
      View detailed
    </button>
  </div>
