          ...
          <div className="w-full md:w-1/2 px-4">
                  ...
                  <button
                    ...
                    className={`border px-4 py-2 rounded-lg ${
                      selectedOption === option
                        ...
                        : 'bg-white border-2 border-black text-black hover:bg-gray-200'
                    } focus:outline-none`}
                ...
                {product.colors.map((color: string) => (
                  <button
                    ...
                    className={`flex items-center gap-2 border px-4 py-2 rounded-lg ${
                      selectedColor === color
                        ? 'bg-gray-200 text-black border-black-500'  
                        : 'bg-white border border-black-500 text-black hover:bg-gray-200'
                    } focus:outline-none`}
            ...
            <div className="flex items-center mt-6 space-x-4">
              ...
              <div className="flex items-center border border-gray-300 rounded-lg">
                <button
                  className="px-4 py-2 text-white bg-black-500 hover:bg-gray-200"
              ...
              {/* Add to Cart Button */}
              <button className="text-white bg-black-500 px-6 py-2 rounded-lg flex items-center justify-center w-full md:w-auto hover:bg-gray-700">
