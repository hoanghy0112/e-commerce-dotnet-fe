...
export default function ProductDetail() {
  ...
  const [isMounted, setIsMounted] = useState(false); // Trạng thái kiểm tra môi trường client

  useEffect(() => {
    setIsMounted(true); // Đánh dấu khi component đã mount trên client
  }, []);

  if (!isMounted) return null; // Ngăn không cho chạy khi đang SSR
