// app/api/product/[product_id]/route.js
...
const products = [
  {
    ...
    description: "iPhone 15 Plus offers a stunning design and powerful performance. It comes with the latest A16 Bionic chip, 5G connectivity, and an impressive camera system.",
  },
  // Bạn có thể thêm nhiều sản phẩm khác vào đây
];

// Xử lý yêu cầu GET đến /api/product/{product_id}
