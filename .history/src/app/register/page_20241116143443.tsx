 ...
 return (
    ...
    <div className="w-2/3 flex flex-col justify-center items-center p-8 bg-white rounded-r-lg shadow-md">
        ...
        <form onSubmit={handleSubmit} className="w-3/5">
            <div className="mb-4">
                <label htmlFor="name" className="font-bold text-base text-lg block mb-2">Name</label>
                <input
                    type="text"
                    id="name"
                    name="name"
            ...
            <div className="mb-4">
                <label htmlFor="email" className="font-bold text-base text-lg block mb-2">Email</label>
                <input
                    type="email"
                    id="email"
                    name="email"
          ...
          <button type='submit' className='w-full p-3 text-2xl text-white bg-black-500 rounded-lg font-semi cursor-pointer mb-4'>Sign in</button>
        </form>
