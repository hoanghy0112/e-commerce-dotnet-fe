...
const RegisterPage: React.FC = () => {
 ...
 return (
    <div className="flex h-screen bg-cover bg-center mx-5 my-5 rounded-lg shadow-md" style={{ backgroundImage: 'url(/backgroundsignup.png)' }}>
    <div className="w-1/3 flex items-center justify-center rounded-bl-lg p-8 shadow-inner">
        <div className="w-full h-full bg-cover bg-center rounded-bl-lg" style={{ backgroundImage: 'url(/path/to/left-image.png)' }}></div>
    </div>
