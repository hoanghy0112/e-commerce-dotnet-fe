...
const RegisterPage: React.FC = () => {
 ...
 return (
    <div className="flex h-screen bg-[url('/backgroundsignup.png')] bg-cover bg-center m-5 rounded-r-lg shadow-lg">
    {/* Left Section */}
    <div className="w-1/3 flex items-center justify-center rounded-l-lg p-8 shadow-inner">
        <div className="w-full h-full bg-[url('/path/to/left-image.png')] bg-cover bg-center rounded-l-lg"></div>
    </div>
    ...
    <div className="w-2/3 flex flex-col justify-center items-center p-8 bg-white rounded-r-lg shadow-lg">
        ...
        <button className="w-full p-3 border border-gray-300 rounded-lg flex items-center justify-center font-bold">
