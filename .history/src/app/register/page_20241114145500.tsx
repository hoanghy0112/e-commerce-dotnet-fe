    ...
    <div style={{
        ...
        <form onSubmit={handleSubmit} style={{ width: '80%' }}>
            <div style={{ marginBottom: '1rem' }}>
                <label htmlFor="name" style={{ fontWeight: 'semibold', fontSize: '16px', display: 'block', marginBottom: '0.5rem' }}>Name</label>
                <input
                    type="text"
                    id="name"
                    name="name"
            ...
            <div style={{ marginBottom: '1rem' }}>
                <label htmlFor="email" style={{ fontWeight: 'semibold', fontSize: '16px', display: 'block', marginBottom: '0.5rem' }}>Email</label>
                <input
                    type="email"
                    id="email"
                    name="email"
            ...
            <div style={{ marginBottom: '1rem' }}>
                <label htmlFor="password" style={{ fontWeight: 'semibold', fontSize: '16px', display: 'block', marginBottom: '0.5rem' }}>Password</label>
                <input
                    type="password"
                    id="password"
                    name="password"
